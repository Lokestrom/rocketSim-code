...
#include "../openGL/callbacks.hpp" // Custom user callback
...
void ImGui_ImplGlfw_MouseButtonCallback(GLFWwindow* window, int button, int action, int mods)
{
    ...
    if (ctx->NavWindow != nullptr) {
        window_name = ctx->NavWindow->Name;
        OpenGL::mouseButtonCallback(window_name, window, button, action, mods);
    }
...
void ImGui_ImplGlfw_KeyCallback(GLFWwindow* window, int keycode, int scancode, int action, int mods)
{
    ...
    if (ctx->NavWindow != nullptr) {
        window_name = ctx->NavWindow->Name;
        OpenGL::keyCallback(window_name, keycode, scancode, action, mods);
    }
